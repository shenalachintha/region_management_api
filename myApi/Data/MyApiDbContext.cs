    ...
    public class MyApiDbContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var difficulties = new List<Difficulty>()
            {
                new Difficulty()
                {
                    id=Guid.Parse("4643a6fd-a61f-42d1-877e-982951552bf4"),
                    Name="Easy"
                },
                 new Difficulty()
                {
                    id=Guid.Parse("9d21c2c5-57ef-4022-84d0-0bd0def71cce"),
                    Name="Medium"
                },
                  new Difficulty()
                {
                    id=Guid.Parse("ca8951f4-565e-4ea3-806c-3757b7a69767"),
                    Name="Hard"
                },
            };
